package com.infobk.translatetr.DataBase;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "MyDatabase.yedekson.db";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        if (i > i1)
        {
            Log.v("Database güncel", "Database versionu eski.");
            deleteDatabase();
        }
    }
    ...
    public void deleteDatabase()
    {
        ...
        if(file.exists())
        {
            file.delete();
            if(file.delete()==true){
                Log.d("DB_LOG","Database APK içinde silindi.");
            }else{
                Log.d("DB_LOG","Veritabanı dosyası silinmez !");
            }
        }
    }
